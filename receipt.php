...
<div id="container">
	...
	<h3>Paul's Paintings Shop</h3>
		<h3>Thank you for your Order!</h3>
			...
			echo "<tr width='auto'>" . "<h3> 1) Shipping Address </h3>" . "</td>";
			echo "<td width='auto'>"  . $fname . " " . $lname . "</td>";
			echo "<td width='auto'>"  . $add1 . ", " . "</td>";
			echo "<td width='auto'>"  . $add2 . " " . "</td>";
			echo "<td width='auto'>"  . $city . ", " . $state . ", " . $zip . " " . "</td>";
			echo "<td width='auto'>"  . $country . " " . "</td>";
			...
			echo "<table width= 'auto'>";
			echo "<tr>";
			echo "<td width='auto'>" . "Billing address: ". "</td>";
			echo "<td width='auto'>"  . $fname . " " . $lname . ", " . "</td>";
			echo "<td width='auto'>"  . $add1 . "" . "</td>";
			echo "<td width='auto'>"  . $add2 . "" . "</td>";
			echo "<td width='auto'>"  . $city . ", " . $state . ", " . $zip . " " . "</td>";
			...
			echo "<tr>";
			echo "<td width='auto;'>"  . "Payment: " . "</td>";
			echo "<td width='auto;'>" . $type . "</td>";
			echo "<td width='auto;'>" . FormatCreditCard(MaskCreditCard(($cardnum))) . "</td>";
			...
			echo "<tr>" . "<td>"  . "<h3> 3) Order Items </h3>" . "</td>" . "</tr>";
			echo "<table>";
			...
			<table>
			<tr>
			<td><button onclick="myFunction()">Print this page</button></td>
			</tr>
		</div>
	</div>
</body>
